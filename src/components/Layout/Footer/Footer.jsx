					...
					<div className="footer-links">
						<div className="links">
							<div>
								...
								<button class="link-style">Careers</button>
								<button class="link-style">Contact Us</button>
								<button class="link-style">Feedback</button>
							</div>
							<div>
								<h5>Legal</h5>
								<button class="link-style">Terms</button>
								<button class="link-style">Conditions</button>
								<button class="link-style">Cookies</button>
								<button class="link-style">Copyright</button>
							</div>
							<div>
								<h5>Follow</h5>
								<button class="link-style">Facebook</button>
								<button class="link-style">Twitter</button>
								<button class="link-style">Instagram</button>
								<button class="link-style">Youtube</button>
							</div>
						</div>
